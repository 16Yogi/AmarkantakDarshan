    ...
    <form action="<?php $_SERVER['PHP_SELF'];?>" method="POST" enctype="multipart/form-data">
        <div class="container-fluid bg-dark text-white">
           <div class="container text-center">
                <h1 class="py-1">Amarkantak Darshan | Admin Pannel</h1>
        ...
        <div class="container-fluid">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 py-4 " id="content">
                       <img src="img/banner/<?php echo $b1img; ?>" alt="">
                    </div>                    
                </div>
                <h4>Food Service Banner</h4>
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 py-4 text-center" id="content">
                       <input type="file" class="form-control" name="img3">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 py-4 " id="content">
                       <img src="img/banner/<?php echo $b3img; ?>" alt="">
                    </div>                    
                </div>
                <h4>Hotel Service Banner</h4>
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 py-4 text-center" id="content">
                       <input type="file" class="form-control" name="img4">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 py-4 " id="content">
                       <img src="img/banner/<?php echo $b4img; ?>" alt="">
                    </div>                    
                </div>
                <h4>Vehical Service Banner</h4>
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 py-4 text-center" id="content">
                       <input type="file" class="form-control" name="img5">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 py-4 " id="content">
                       <img src="img/banner/<?php echo $b5img; ?>" alt="">
                    </div>                    
                </div>
                <h4>Tour Service Banner</h4>
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 py-4 text-center" id="content">
                       <input type="file" class="form-control" name="img6">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 py-4 " id="content">
                       <img src="img/banner/<?php echo $b6img; ?>" alt="">
                    </div>                    
                </div>
                <h4>Bus Service Banner</h4>
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 py-4 text-center" id="content">
                       <input type="file" class="form-control" name="img7">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 py-4 " id="content">
                       <img src="img/banner/<?php echo $b7img; ?>" alt="">
                    </div>                    
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 py-4 text-center" id="content">               
        ...
        <div class="container-fluid" id="bg-1">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 py-4 text-center" id="content">
                       <input type="file" class="form-control" name="aimg2">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 py-4" id="content">
